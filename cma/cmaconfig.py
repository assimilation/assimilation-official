...
class ConfigFile(object):
    ...
    def default_defaults():
        ...
        retval = {
            ...
            "score_severity_map": {
                "security": {"high": 3.0, "medium": 2.0, "low": 1.0},
            ...
            "monitoring": {
                ...
                "nagiospath": [
                    "/usr/lib/nagios/plugins",  # places to look for Nagios agents
            ...
            "checksum_files": ["/bin/sh", "/bin/bash", "/bin/login", "/usr/bin/passwd"],
...
for container in ConfigFile.default_template["containers"]:
    ConfigFile.default_template["containers"][container][
        "initial_discovery"

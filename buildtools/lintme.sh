...
then
  ...
  LIST='AssimCclasses.py assimevent.py assimjson.py cmadb.py cmainit.py cma.py consts.py dispatchtarget.py droneinfo.py frameinfo.py graphnodes.py hbring.py messagedispatcher.py packetlistener.py query.py store.py transaction.py monitoring.py flask/hello.py'
else
  LIST="$@"
fi

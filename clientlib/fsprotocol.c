...
// SHUT1: no ACK, no CONNSHUT 
/*SHUT1*/{0,	A_OOPS, 0,      A_OOPS,   A_CLOSE,   A_ACKME,           A_ACKTO|A_TIMER,       A_TIMER, CLOSETIME},
// SHUT2: got CONNSHUT, Waiting for ACK
/*SHUT2*/{0,	A_OOPS, 0,      0,        A_CLOSE,   A_ACKME,           A_ACKTO|A_TIMER,       A_CLOSE, CLOSETIME},
// SHUT3: Got ACK, waiting for CONNSHUT
/*SHUT3*/{0,	A_OOPS, A_OOPS, A_OOPS,   A_CLOSE,   A_ACKME|A_CLOSE,   A_ACKTO|A_TIMER|A_OOPS,A_OOPS,  CLOSETIME},
};

...
# You can find libsodium-last at
# ftp://mandril.creatis.insa-lyon.fr/linux/remi/enterprise/6/remi/$ARCH/libsodium-last-1.0.1-1.el6.remi.$ARCH.rpm
# and libsodium-last-devel at
# ftp://mandril.creatis.insa-lyon.fr/linux/remi/enterprise/6/remi/$ARCH/libsodium-last-devel-1.0.1-1.el6.remi.$ARCH.rpm
# We really need to add those to our repositories...
%if %(test -z  "%{?libsodium}" && echo 1 || echo 0)
...
%if %{uses_systemd}
install -p -D -m0644 %{_builddir}/%{assimversion}/docker/CentOS6/assimilation-cma.service %{buildroot}%{_unitdir}/assimilation-cma.service
install -p -D -m0644 %{_builddir}/%{assimversion}/docker/CentOS6/assimilation-nanoprobe.service %{buildroot}%{_unitdir}/assimilation-nanoprobe.service
%else
